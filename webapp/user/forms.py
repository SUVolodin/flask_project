...
class LoginForm(FlaskForm):
    ...
    password = PasswordField("Ввдите пароль", validators=[DataRequired()], render_kw={"class": "form-control"})
...
class RegistrationForm(FlaskForm):
    username = StringField("Имя пользователя", validators=[DataRequired()], render_kw={"class": "form-control"})
    email = StringField("Электронаая почта", validators=[DataRequired(), Email()], render_kw={"class": "form-control"})
    password = PasswordField("Ввдите пароль", validators=[DataRequired()], render_kw={"class": "form-control"})
