...
class Client:
    ...
    def run_wsgi_app(
        ...
        """Runs the wrapped WSGI webapp with the given environment.
    ...
    def open(
        ...
        **kwargs: t.Any,
        ...
        :param buffered: Convert the iterator returned by the webapp into
...
def run_wsgi_app(
    ...
    """
    # Copy environ to ensure any mutations by the webapp (ProxyFix, for
